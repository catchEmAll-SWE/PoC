...
\begin{enumerate}
    ...
    \item Viene generata un'immagine aggiuntiva che funge da honeypot\textsubscript{G};
...
\begin{enumerate}
    ...
    \item Il CAPTCHA\textsubscript{G} viene generato utilizzando solo le immagini presenti nel database interno;
    \item Il CAPTCHA\textsubscript{G} immagini viene restituito alla WebApp.
\end{enumerate}
...
\paragraph{UC8.2 - Verifica superamento Honeypot}
\textbf{Attore primario:} WebApp.\\
