...
\begin{tabularx}{\textwidth}{| c | c | X | X |} 
 ...
 \hline
 RF-5 & Obbligatorio &  L'utente deve superare il CAPTCHA immagini proposto dal sistema per poter effettuare il login &  UC1.2, Capitolato, VE\_20221111\\
  \hline
 RF-6 & Obbligatorio & Alla correttezza della soluzione del CAPTCHA immagini fornita dall'utente viene applicato un margine di errore &  UC1.2, VE\_20221111\\
\hline
 RF-7 & Opzionale & L'utente deve superare una trappola honeypot per poter effettuare il login &  UC1.3\\
 \hline
 RF-8 & Opzionale & L'utente deve calcolare il proof of work per poter effettuare il login &  UC1.4, VE\_20221111\\
 \hline
 ...
 \hline
 RF-10 & Obbligatorio & All'utente viene mostrato un messaggio di errore nel caso in cui abbia superato il numero massimo di tentativi di login consentito &  UC2.5, VI\_20221115\\
 \hline
 RF-11 & Obbligatorio &  L'utente deve poter richiedere la generazione di un altro CAPTCHA immagini &  UC3, VI\_20221115\\
 \hline
 RF-12 & Obbligatorio & All'utente viene mostrato un messaggio di errore nel caso in cui abbia superato il limite di richieste di rigenerazione CAPTCHA immagini &  UC4\\
 \hline
  RF-13 & Obbligatorio & Il sistema deve fornire la possibilità di richiedere la generazione di un CAPTCHA immagini & UC5, VE\_20221214\\
   \hline
  RF-14 & Obbligatorio & Il sistema deve comunicare un'eventuale errore nella generazione di un CAPTCHA immagini & UC6, VE\_20221214\\
   \hline
  RF-15 & Opzionale & Il sistema deve richiedere il calcolo il proof of work & UC7, VE\_20221111\\
   \hline
  RF-16 & Obbligatorio & Il sistema deve offrire le funzionalità di verifica della correttezza del CAPTCHA compilato dall'utente & UC8, VE\_20221214\\
 \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{| c | c | X | c |} 
 ...
 \textbf{ID Requisito} & \textbf{Classificazione} & \textbf{Descrizione} & \textbf{Fonti} \\
 \hline
 RQ-1 & Obbligatorio &  Il captcha deve mitigare potenziali attacchi “brute force” & Capitolato, VE\_20221111\\
 \hline
