...
\subsection{Sviluppo}
    ...
    Una volta revisionata la issue, se presenta qualche problema può essere spostata allo stato "in progress" dal pannello JIRA, altrimenti attraverso pull request nel ramo "main" e con comando
    \begin{lstlisting}
