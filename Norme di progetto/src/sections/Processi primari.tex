...
\subsection{Sviluppo}
    ...
    \paragraph{Struttura dei requisiti}: ogni requisito è identificato da un codice univoco così composto:
    \newline
    ...
    \verb|UC<<id>>|
    \newline
    Dove id identifica l'use case stesso.
    

    \paragraph{Struttura casi d'uso}
