...
Questo documento stilato dagli analisti del gruppo contiene tutti i requisiti\textsubscript{G} e casi d'uso individuati per il progetto. I seguenti sono ottenuti dal documento di presentazione del capitolato e in seguito integrati sia attraverso discussioni tra i membri del gruppo, sia organizzando incontri con il proponente. 
...
\subsection{Sviluppo}
	...
	\subsubsubsection{Scopo e descrizione}
	Lo scopo di questa fase è quello di individuare le varie caratteristiche che comporranno il prodotto richiesto dal proponente. Queste verranno individuate attraverso i vari requisiti\textsubscript{G} e casi d'uso identificati nella fase \textit{Analisi dei requisiti}. Le varie caratteristiche verranno poi messe insieme per costruire una singola soluzione che rispetti i vari obiettivi di qualità del prodotto.
