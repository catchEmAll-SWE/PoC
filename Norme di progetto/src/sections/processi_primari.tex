...
\subsection{Sviluppo}
	...
	\begin{itemize}
		\item Periodo nel quale vengono identificati i requisiti del \textit{Poc\textsubscript{G}} e delle 	tecnologie necessarie a svilupparlo, oltre che lo studio di queste ultime;
